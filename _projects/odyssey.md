...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odyssey_wireframe.png" title="Odyssey wireframe" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Project Odyssey section view
</div>
